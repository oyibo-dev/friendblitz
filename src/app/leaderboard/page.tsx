...
export default function Page() {
  ...
  // Get the session cookie from the cookie store
  const session = cookieStore.get("session");

  // If the session cookie is present, redirect the user to the "/join" page
  if (session?.value) redirect("/join");
  ...
  return (
    <>
      ...
      <main className="flex-grow">
        <section>
          <div className="items-center w-full grid mx-auto 2xl:max-w-7xl p-8 lg:p-20 2xl:border-x-2 border-black">
            <div className="max-w-3xl mx-auto text-center lg:py-32">
              <p className="text-3xl lg:text-5xl font-medium text-black max-w-4xl mx-auto">
                We are coming soon
              </p>
              <p className="max-w-lg mt-4 xl:text-xl tracking-wide text-black">
